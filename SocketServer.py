...
console_logger.setLevel(logging.INFO)
file_handler = FlushingFileHandler("log.log", formatter=logging.Formatter(FORMAT), encoding='utf-8')
...
class Server():
    def __init__(self, args):
        ...
        # Sentiment Engine
        self.sentiment = SentimentEngine.SentimentEngine('SentimentEngine/models/sentiment_onnx.onnx')
